...
function VideoPlayer({
  ...
  onProgressUpdate,
  progressData,
  inline = true,      // new: hint to keep playback inline on mobile
  light = false,      // new: allow poster mode if you ever want it
}) {
  // If there’s no URL, don’t render a black video surface at all.
  if (!url) {
    return null;
  }
