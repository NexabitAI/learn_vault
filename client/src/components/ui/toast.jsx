...
const ToastViewport = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 pointer-events-none",
  ...
  <ToastPrimitives.Action
    ...
    className={cn(
      [
        ...
        "rounded-[calc(var(--radius)-4px)] border border-[hsl(var(--border))]",
        ...
        "group-[.destructive]:hover:border-white/60",
        "group-[.destructive]:hover:bg-white/10",
        "group-[.destructive]:text-[hsl(var(--destructive-foreground))]",
      ].join(" "),
      className
    )}
    {...props}
...
const ToastClose = React.forwardRef(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ...
    className={cn(
      [
        "absolute right-1 top-1 rounded-[calc(var(--radius)-6px)] p-1",
        ...
        "group-[.destructive]:focus:ring-white/70 group-[.destructive]:focus:ring-offset-transparent",
      ].join(" "),
      className
    )}
    {...props}
