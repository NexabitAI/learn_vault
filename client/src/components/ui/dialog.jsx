  ...
  ({ className, showOverlay = true, children, ...props }, ref) => (
    <DialogPortal>
      ...
      <DialogPrimitive.Content
        ref={ref}
        className={cn(
          "fixed left-1/2 top-1/2 z-[61] grid w-full max-w-lg -translate-x-1/2 -translate-y-1/2 gap-4",
          "border border-[hsl(var(--border))]",
          "bg-[hsl(var(--card))] text-[hsl(var(--foreground))]",
          "p-6 shadow-[var(--shadow)] duration-200",
          "data-[state=open]:animate-in data-[state=closed]:animate-out",
          "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0",
          "data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95",
          "data-[state=closed]:slide-out-to-left-1/2 data-[state=closed]:slide-out-to-top-[48%]",
          "data-[state=open]:slide-in-from-left-1/2 data-[state=open]:slide-in-from-top-[48%]",
          "sm:rounded-[var(--radius)] focus:outline-none",
          className
        )}
        {...props}
      >
        ...
        <DialogPrimitive.Close
          className={cn(
            "absolute right-4 top-4 rounded-[calc(var(--radius)-6px)] opacity-70",
