        ...
        <aside className="w-full md:w-72 space-y-4">
          <div className="glass rounded-xl p-4">
            {Object.keys(filterOptions).map((ketItem) => (
              <div className="py-4 border-b last:border-b-0" key={ketItem}>
          ...
          <div className="flex justify-end items-center mb-4 gap-5">
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <Button variant="outline" size="sm" className="flex items-center gap-2 px-5">
                ...
                <Card onClick={() => handleCourseNavigate(courseItem?._id)} className="cursor-pointer course-card">
                  <CardContent className="flex gap-4 p-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-[16px] text-muted-foreground mt-3 mb-2">
